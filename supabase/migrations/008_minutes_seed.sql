...
SET minutes = CASE o.seq
  WHEN 1 THEN '{
    ...
    "discussions": [
      { "item": "1주차 다이어리 제출 현황", "notes": "10명 중 7명 제출 완료. P-003, P-007, P-009 미제출 확인. P-009는 개인 사정으로 연락 불가 상태." },
      { "item": "첫 인터뷰 일정 조율", "notes": "P-001 ~ P-004 현장 인터뷰 6/20 ~ 6/21 예정. 장소는 클라이언트 사무실 3층 회의실." },
      { "item": "스크리너 문항 해석 이슈", "notes": "Q3 문항(디지털 기기 사용 빈도)이 모호하다는 참여자 피드백. 다음 회차부터 보충 설명 추가 필요." }
    ],
    "decisions": [
  ...
  WHEN 2 THEN '{
    ...
    "discussions": [
      { "item": "P-009 대체 인원 확보 결과", "notes": "P-011로 대체 확정. 스크리너 통과 완료. 다이어리 키트 발송 예정 (6/18)." },
      { "item": "현장 인터뷰 준비 사항 최종 점검", "notes": "녹음 장비 2세트 준비 완료. 동의서 법무 검토 통과. 대기 공간 클라이언트 3층 확보." },
      { "item": "2주차 다이어리 데이터 중간 검토", "notes": "제출률 90%로 1주차 대비 개선. 주요 패턴: 오전 루틴 중 디지털 전환 시점 다수 발견. 오후 업무 중 끊김(interruption) 경험 반복 언급." },
      { "item": "관찰자 참여 범위 조율", "notes": "박민준 옵저버로 20일 인터뷰 1건 참관 예정. 참여자 동의 필요 — 인터뷰 당일 사전 고지." }
    ],
    "decisions": [
