...
const COL = 'grid-cols-[3.5rem_9rem_7rem_4.5rem_4.5rem_8rem_5.5rem]'
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="glass-card rounded-xl overflow-hidden">
        {/* 헤더 */}
        <div className={`grid ${COL} gap-4 px-5 py-2.5 bg-surface-container border-b border-outline-variant`}>
          {[
            { label: 'ID' },
            { label: '이름' },
            { label: '그룹' },
        ...
        {sorted.map((p, i) => {
          ...
          return (
            <Link
              ...
              className={`grid ${COL} gap-4 items-center px-5 py-3 hover:bg-surface-container-low transition-colors group ${
